...
**** TODO Scene linking
    ...
    individual scenes that other users (login required for now) can view.
**** TODO Scene ratings
...
**** TODO Automatically add slug lines.
     ...
     include the slug line for that area.
...
**** TODO Scene editing
     ...
     draggable. I don't think I want to allow full editing of scenes, but this might be a really
     neat feature that allows cleaning up garbage without giving too much freedom (or requiring too
...
*** TODO Add a 'choose character' dropdown.
    This means -to the chat screen-.
*** TODO Make sure a user is chatting as a character only once.
*** TODO Confirm again that users can't play as someone else's character.
*** TODO Use account _id instead of account_name for characters
    ...
    NOTE: Unnecessary for now. Accounts are pretty much unique identifiers.
*** TODO OOC pane
