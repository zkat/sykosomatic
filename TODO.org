...
*** TODO Require a character to exist before a user can chat.
...
*** TODO Allow players to play multiple characters in different tabs/windows on a single account.
...
**** TODO Add 'record' and 'stop recording' buttons to chat page.
...
** Webapp
*** TODO Reorganize app into MVC-like thing.
    Start with having separate handlers for GET/POST (if possible)
