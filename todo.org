...
**** TODO (maybe) Support phrasal verbs
      "wave off", "give up", "give in"
      This sounds like it could be particularly tricky...
      "X waves Y off" is possible, although "X waves off Y" is good enough.
      It may not be worthwhile to even have this. Come up with some more inspiring phrasal verbs to
      justify the effort.
